...
public class GeminiAPITest {
    ...
    // replace the following with a real API key from https://aistudio.google.com/app
    private static final String API_KEY = "AIzaSyARXMkXQLj8Pfrar6n6yiorsVXmu6Plf9E";

    public static String getGeminiApiKey() {
        if (API_KEY == null) {
            throw new IllegalStateException("API_KEY is null. Please set it to a valid API key from https://aistudio.google.com/app");
        }
        return API_KEY;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (var genAi = new GenAi(API_KEY, parser)) {
